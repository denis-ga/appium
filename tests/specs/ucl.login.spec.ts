...
describe('UCL User Login', () => {
    ...
    it('Login with Email and Password', async () => {
        ...
        await HomeScreen.goingToLogin('UCL');
        await LoginScreen.IDPLogin({ username: 'kobiton1@mailinator.com', password: 'Test123456!' });
        await expect(await HomeScreen.profileHeaderUCL).toHaveTextContaining('Hi, kob');
    });
    ...
    //     await driver.pause(3000);
    //     await expect(await HomeScreen.profileHeaderUCL).toHaveTextContaining('Hi, Denis');
    // });
