...
describe('UEL User Login', () => {
    ...
    it('Login with Email and Password', async () => {
        ...
        await HomeScreen.goingToLogin('UEL');
        await LoginScreen.IDPLogin({ username: 'kobiton1@mailinator.com', password: 'Test123456!' });
        await expect(await HomeScreen.profileHeaderUEL).toHaveTextContaining('Hi, kob');
    });
    ...
    //     await driver.pause(3000);
    //     await expect(await HomeScreen.profileHeaderUEL).toHaveTextContaining('Hi, Denis');
    // });
